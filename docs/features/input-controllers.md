...
|--------|-----------|-------|
| Nintendo Switch Pro Controller (v1 & v2) | USB, Bluetooth | Full button + rumble support |
| GameCube Wireless Adapter | USB | Analog triggers mapped |
| Xbox One / Series X\|S | USB, Bluetooth, Wireless Adapter | Full support |
| PlayStation DualShock 3 | USB | May need driver (DS4Windows) |
| PlayStation DualShock 4 | USB, Bluetooth | Full support including touchpad |
| PlayStation DualSense (PS5) | USB, Bluetooth | Full support including adaptive triggers |
| 8BitDo Pro 2 / Ultimate | USB, Bluetooth | Full support in XInput mode |
| Keyboard | — | Full rebinding |
...
3. Press the desired key/button

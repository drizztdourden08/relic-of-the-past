<!-- @layer docs @kind doc -->
# State Queries for Inventory & Progress
...
|------:|-------|------:|-------|
| 0-2 | game mode: main / sub / subsub module | 61-68 | text/dialogue (message idx u16, render state, countdown u16, and so on) |
...
`int WasmGetUIOverlayMode(void)` · `void WasmSetUIOverlayMode(int mode)` get and set an overlay

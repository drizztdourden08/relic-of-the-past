...
Three volume setters, all on a **0–128** scale (mapping to `SDL_MIX_MAXVOLUME`). Music/SFX setters
...
> user-facing controls these back, and note that MSU-1 music streaming is handled in the Electron/JS

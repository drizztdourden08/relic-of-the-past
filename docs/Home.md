...
polished UI, controller support, save profiles, MSU-1 audio, visual enhancements, and
...
| **Learn a feature** — saves, controllers, HUD, MSU, cheats… | [User Guide](user-guide/profiles.md) |
...
> folder in the main repo — the source of truth.** Edit the docs there; the wiki is synced

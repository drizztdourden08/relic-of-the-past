...
4. **Group by concept in folders** — prefer deep logical structure over flat directories.
5. **Small files, high reusability** — if a file exceeds ~150 lines, it likely needs splitting.

...
// kFeatures3_ReceiptExport (an independent gate, like kFeatures3_ItemOverrides, with no
...
int WasmGrantItemWithReceipt(int item_id) {
  ...
  // A delivery carries an already-assigned item, so the npc-override seam must not

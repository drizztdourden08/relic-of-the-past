...
// map16_decode_tmp, in variables.h) sits at +0x14400 through +0x14443, inside the same span the
...
// separate loads. A "query" run mid-session still has no business leaving whatever it decoded sitting

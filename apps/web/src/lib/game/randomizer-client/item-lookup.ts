 ...
 * progressive-receive-id contracts) — a progressive copy is mapped to its next
 ...
 * id outside 0x00-0x4B resolves as undefined rather than reaching the core.
 */
...
/**
 * The record id behind a standard item name, for DISPLAY (label, sprite) — no

 ...
 * `window.api.uiViews`, debounced and app-level, not profile-level (see
...
/** Drops any entry that isn't a well-formed snapshot instead of trusting untyped disk JSON. */

...
interface ProgressBarProps {
  ...
  /**
   * Set for a bar whose value is sampled continuously rather than changed now and then. The fill
   ...
   * value resets. This turns the easing off so the fill simply IS the value.
   */
  live?: boolean;
  className?: string;
}

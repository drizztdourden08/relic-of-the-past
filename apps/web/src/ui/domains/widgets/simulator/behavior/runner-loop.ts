...
/**
 * Side helpers for the simulator runner: the per-screen SimObservation, fanning
 * events out to the store / log-bus / JSONL sink, FLOOD + Sequence log events,
 * and the inter-step frame wait.
 */
...
/** Detected exits with their walk-step distances, which is the closest-first evidence. */

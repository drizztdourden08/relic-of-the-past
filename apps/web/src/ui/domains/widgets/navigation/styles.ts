...
const S: Record<string, CSSProperties> = {
  ...
  valDim: { color: 'var(--c-text-dim)' },
  valPos: { color: 'var(--c-green-bright)' },
  valInfo: { color: 'var(--c-info)' },
  valMuted: { color: 'var(--c-text-muted)' },
  valWarning: { color: 'var(--c-warning)' },
  valGreen: { color: 'var(--c-green)' },
  valBadge: { color: 'var(--c-text-muted)', marginLeft: 4, fontSize: 10 },
  multiCount: { fontSize: 9, color: 'var(--c-text-muted)', marginLeft: 6 },
  fnRowTop: { display: 'flex', flexWrap: 'wrap', gap: 4, marginTop: 4 },

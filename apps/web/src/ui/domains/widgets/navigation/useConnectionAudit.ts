...
/**
 * Connection audit — cross-checks the static dataset for the current screen
 * against the game's REAL in-game transitions.
 *
...
const buildBadFindings = (screenId: ScreenId, realTransitions: RealTransition[]): ConnectionSuggestion[] => {
 ...
 */
const buildAddFindings = (screenId: ScreenId, unmatched: DetectedConnection[], floodConnections: ConnectionInfo[]): ConnectionSuggestion[] => {

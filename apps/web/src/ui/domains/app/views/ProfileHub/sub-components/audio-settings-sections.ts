    ...
    subsections: [
      {
        ...
        items: [
          ...
          { key: 'enableMSU', label: 'Pack Format', description: 'MSU, Deluxe, OPUZ or Deluxe OPUZ, read from the pack in Auto and chosen by hand in Manual. Packs are imported and assigned in the Data Manager.', keywords: 'msu music cd replacement deluxe opuz pack format' },
          ...
          { key: 'resetMSUAtTitle', label: 'Reset At Title Screen', description: 'Reaching the title screen forgets every remembered position, so the opening plays from its start alongside the animation and a new run begins with fresh music instead of picking up the last one midway.', keywords: 'reset title intro restart new game fresh resume position' },
        ],
      },
      {
        id: 'msu-sounds',

...
const syncedRateDescription = (status: SyncedRateStatus): string => {
  ...
  const base = 'While in fullscreen, switch the display to a refresh rate that divides evenly into the game’s 60 frames a second, and put your original rate back when you leave fullscreen or quit. Only the refresh rate changes; the resolution is left alone.';

...
/**
 * Usage instructions for the HID Calibration Wizard, covering how to read the byte
  ...
  return (
    <Box as="details" className="hid-cal__step hid-cal__instructions" open>
      ...
      <Box className="hid-cal__instructions-alert">
        Most failed calibrations come from an unexcluded noisy byte, not a wrong bind, so check the grid first.
      </Box>
    </Box>
  );
};

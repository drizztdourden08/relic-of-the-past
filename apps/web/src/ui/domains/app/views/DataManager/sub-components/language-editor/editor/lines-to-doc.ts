...
/**
 * Lines to editor document — the forward half of the bridge.
 *
 ...
 *
 * A line's advance code and its trailing wait become paragraph attributes rather
 * than nodes in the run, so nothing about them is representable in the wrong

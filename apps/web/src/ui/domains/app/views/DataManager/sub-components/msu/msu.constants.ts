...
/** What a drop zone accepts. Nothing is transcoded on the way in; the engine decodes each of these itself. */
...
/** What each role means, for the row's tooltip; the labels alone are too terse. */

 ...
 * change handler the rows render as the catalog's own fixed values — the
 ...
 * row it explains rather than in a list underneath them all.
 */
...
interface OptionGroupListProps {
  ...
  live?: boolean;
  /** Unlocked rows this tab freezes anyway — a sibling setting decides them. */

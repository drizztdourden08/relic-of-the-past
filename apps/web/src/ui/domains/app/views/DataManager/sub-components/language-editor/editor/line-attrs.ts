...
/**
 * The attribute contract of ONE LINE. It covers everything a paragraph has to
 * remember that is not its text.
 *
 ...
 *
 * The advance is stored as a kind plus a row, not as the model's union, because
 * a ProseMirror attribute has to survive a trip through the DOM
 ...
 * first row, not to nothing: the line was authored WITH a code, and

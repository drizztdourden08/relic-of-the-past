...
export function drawCliffArrows(dc: DrawContext, drawResults: FloodFillResult[]): void {
...
export function drawStairArrows(dc: DrawContext, drawResults: FloodFillResult[]): void {

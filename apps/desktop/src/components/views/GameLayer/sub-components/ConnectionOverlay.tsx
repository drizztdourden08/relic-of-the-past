...
function ConnectionOverlay({ width, height, gameRunning }: Props) {
  ...
  const { visible, result, results, connections, fallHoleSpawns, respawnEntIds, setLockedPath } = useConnectionOverlayStore();
  ...
  }, [visible, result, results, connections, fallHoleSpawns, respawnEntIds, width, height, gameRunning, activeScreenIndex, isIndoors, roomIndex, overworldScreenIndex, layer1ReachableOverride]);

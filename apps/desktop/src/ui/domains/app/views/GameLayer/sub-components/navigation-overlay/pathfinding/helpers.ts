...
const keyOf = (pos: GridPos): string => {
...
const segmentOverlapsRect = (a: { x: number; y: number }, b: { x: number; y: number }, rect: Rect, margin: number): boolean => {
...
const isValid2x2 = (row: number, col: number, reachable: ReachState[][]): boolean => {
...
const isTraversalDirCompatible = (state: number, dr: number, dc: number): boolean => {
  switch (state) {
...
const isValidMove2x2 = (nr: number, nc: number, dr: number, dc: number, reachable: ReachState[][]): boolean => {
...
const canLeave2x2 = (row: number, col: number, dr: number, dc: number, reachable: ReachState[][]): boolean => {

...
module.exports = {
  ...
  extraResources: [
    ...
    // The .msul document icon, as a real file the Windows registry can point at:
    // apps/desktop/electron/msu/msul-association.ts registers it from process.resourcesPath.
    // Generated by make-msul-icon.mjs in the prebuild step, the same as the entry below uses.
    {
  ...
  // Music packs authored in the app get their own document type, so double-clicking one
  // imports it. The icon is generated by scripts/build/make-msul-icon.mjs.
  fileAssociations: [
    {
      ext: 'msul',
      name: 'Music Pack',

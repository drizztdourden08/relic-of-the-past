...
const ROLE_RULES = [
  ...
  ['apps/desktop/src/lib/game/', 'bridge-wasm'],
  ['apps/desktop/src/lib/', 'renderer-lib'],
  ['apps/desktop/src/stores/', 'renderer-stores'],
  ['apps/desktop/src/widgets/', 'renderer-widgets'],
  ['apps/desktop/src/hud/', 'renderer-hud'],
  ['apps/desktop/src/design-system/', 'renderer-design-system'],
  ['apps/desktop/src/components/', 'renderer-components'],
  ['apps/desktop/src/App/', 'renderer-appshell'],
  ['apps/desktop/src/', 'renderer-other'],
  ['apps/desktop/public/', 'renderer-public'],

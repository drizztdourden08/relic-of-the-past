...
// Vitest runs with Vite's default BASE_URL of '/'. Any leading "/" or "./" is
// stripped before the base is applied, so no doubled separator. In the packaged
// renderer BASE_URL is "./", yielding "./buttons/...".

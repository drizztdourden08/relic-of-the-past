...
const HUD_SPRITES: SpriteManifestEntry[] = [
  ...
  { file: 'hud-scroll',          label: 'Scroll',             category: 'hud' },
  { file: 'hud-mirror-variant',  label: 'Mirror (variant)',   category: 'hud' },
  ...
  { file: 'hud-big-key-crystal', label: 'Big Key / Crystal',  category: 'hud' },

  // Hearts
  { file: 'hud-heart-piece',     label: 'Heart Piece (full)', category: 'hud' },
  ...
  { file: 'hud-heart-container', label: 'Heart Container',    category: 'hud' },
];
...
const RECEIPT_SPRITES: SpriteManifestEntry[] = [
  ...
  { file: 'receipt-bomb-refill',        label: 'Bomb Refill',        category: 'receipt' },
  { file: 'receipt-3-bombs',            label: '3 Bombs',            category: 'receipt' },
  ...
  { file: 'receipt-bomb-capacity',      label: 'Bomb Capacity',      category: 'receipt' },
  { file: 'receipt-arrow-capacity',     label: 'Arrow Capacity',     category: 'receipt' },
  { file: 'receipt-arrow-capacity-2',   label: 'Arrow Capacity (2)', category: 'receipt' },
  { file: 'receipt-bomb-refill-2',      label: 'Bomb Refill (2)',    category: 'receipt' },
  { file: 'receipt-half-magic',         label: 'Half Magic',         category: 'receipt' },
  { file: 'receipt-quarter-magic',      label: 'Quarter Magic',      category: 'receipt' },
  { file: 'receipt-1-rupee',            label: '1 Rupee',            category: 'receipt' },
  { file: 'receipt-5-rupees',           label: '5 Rupees',           category: 'receipt' },
  { file: 'receipt-20-rupees',          label: '20 Rupees',          category: 'receipt' },
  ...
  { file: 'receipt-heart-container-2',  label: 'Heart Container (2)', category: 'receipt' },
  { file: 'receipt-heart-container-3',  label: 'Heart Container (3)', category: 'receipt' },
  { file: 'receipt-100-rupees',         label: '100 Rupees',         category: 'receipt' },
  { file: 'receipt-50-rupees',          label: '50 Rupees',          category: 'receipt' },
  { file: 'receipt-arrow-refill',       label: 'Arrow Refill',       category: 'receipt' },
  { file: 'receipt-arrows',             label: 'Arrows',             category: 'receipt' },
  { file: 'receipt-10-arrows',          label: '10 Arrows',          category: 'receipt' },
  { file: 'receipt-unknown-69',         label: 'Unknown (#69)',      category: 'receipt' },
  { file: 'receipt-300-rupees',         label: '300 Rupees',         category: 'receipt' },
  { file: 'receipt-rupees-alt',         label: 'Rupees (alt)',       category: 'receipt' },
...
const DROP_SPRITES: SpriteManifestEntry[] = [
  ...
  { file: 'drop-bomb-1',       label: 'Bomb (×1)',     category: 'drop' },
  { file: 'drop-bomb-4',       label: 'Bomb (×4)',     category: 'drop' },
  { file: 'drop-bomb-8',       label: 'Bomb (×8)',     category: 'drop' },
  { file: 'drop-small-magic',  label: 'Small Magic',   category: 'drop' },
  { file: 'drop-full-magic',   label: 'Full Magic',    category: 'drop' },
  { file: 'drop-arrow-5',      label: 'Arrow (×5)',    category: 'drop' },
  { file: 'drop-arrow-10',     label: 'Arrow (×10)',   category: 'drop' },

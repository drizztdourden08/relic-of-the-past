...
const SWITCH_ICONS: Record<string, ButtonIcon> = {
  'switch-b':     icon('switch-b', 'B'),
  'switch-a':     icon('switch-a', 'A'),
  'switch-y':     icon('switch-y', 'Y'),
  'switch-x':     icon('switch-x', 'X'),
  'switch-l':     icon('switch-l', 'L'),
  'switch-r':     icon('switch-r', 'R'),
  'switch-zl':    icon('switch-zl', 'ZL'),
  'switch-zr':    icon('switch-zr', 'ZR'),
  'switch-minus': icon('switch-minus', '−'),
  'switch-plus':  icon('switch-plus', '+'),
  'switch-ls':    icon('switch-ls', 'LS'),
  'switch-rs':    icon('switch-rs', 'RS'),
  'switch-dup':   icon('switch-dup', '↑'),
  'switch-ddown': icon('switch-ddown', '↓'),
  'switch-dleft': icon('switch-dleft', '←'),
  'switch-dright':icon('switch-dright', '→'),
};
...
const SNES_NSO_ICONS: Record<string, ButtonIcon> = {
  ...
  'snes-dup':    icon('snes-dup', '↑'),
  'snes-ddown':  icon('snes-ddown', '↓'),
  'snes-dleft':  icon('snes-dleft', '←'),
  'snes-dright': icon('snes-dright', '→'),
};

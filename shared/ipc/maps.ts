...
const INVOKE_MAP = {
  ...
  listLanguageSets: 'languages:listSets',
  getLanguageSet: 'languages:getSet',
  saveLanguageSet: 'languages:saveSet',
  createLanguageSet: 'languages:createSet',
  duplicateLanguageSet: 'languages:duplicateSet',
  ...
  packageDebugReport: 'debug-report:package',

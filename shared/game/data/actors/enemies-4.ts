...
const ENEMY_ACTORS_4: ActorRecord[] = [
  ...
  {
    // Sprite_8D_Arrghi (sprite_main.h) — the fuzzball Arrghus spawns/throws.
    id: 'actor-116',
  ...
  {
    // Sprite_AA_Pikit (sprite_main.h) — an item-stealing thief creature, not a Like Like.
    id: 'actor-130',
  ...
  {
    // Sprite_C7_Pokey (sprite_main.h) — the well-known cactus enemy.
    id: 'actor-132',

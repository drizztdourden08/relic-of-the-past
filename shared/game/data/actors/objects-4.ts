...
const OBJECT_ACTORS_4: ActorRecord[] = [
  ...
  {
    // Sprite_D1_BunnyBeam (sprite_main.h) — census's 'Transform/Smoke' was a malformed dual-guess.
    id: 'actor-239',
  ...
  {
    // Sprite_D5_DigGameGuy (sprite_main.h) — townsfolk NPC, reclassified from 'object'.
    id: 'actor-243',

...
const ENEMY_ACTORS_3: ActorRecord[] = [
  {
    // Sprite_5B_Spark_Clockwise (sprite_main.h) — not a "bubble"; a wall-crawling spark.
    id: 'actor-094',
  ...
  },
  {
    ...
    // (sprite_main.c:559-560) — the counter-clockwise variant of the same sprite.
    id: 'actor-095',
  ...
  {
    // Sprite_80_Firesnake (sprite_main.h) — census's 'Lanmola' wrongly reused the
  ...
  {
    // Sprite_86_Kodongo (sprite_main.h) — census's 'Triceritops' was an appearance-based
    // guess for an unrelated dinosaur; the real decompiled enemy is Kodongo.
    id: 'actor-113',
  ...
  {
    // Sprite_87_KodongoFire (sprite_main.h) — the fire-breathing Kodongo variant, not a Keese.
    id: 'actor-114',

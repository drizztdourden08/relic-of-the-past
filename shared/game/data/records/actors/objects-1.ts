...
/**
 * Phase 8 skeleton from the native sprite-type table (upstream's tables.py
 * kSpriteNames, ~line 860). Ids continue the deterministic enemy/boss/object
 * sort after bosses.ts, the last group. Kind reassignments below keep their
 * original id regardless of kind.
 *
 ...
 * their correct kind here. The naming-pass report has the full list.
 *
...
const OBJECT_ACTORS_1: ActorRecord[] = [
  ...
  {
    // Sprite_0C_OctorokStone (sprite_main.h) is a crumbling rock hazard, Octorok-family.
    id: 'actor-156',
  ...
  {
    // Sprite_1D_FluteQuest (sprite_main.h) is the flute-summon interaction point.
    id: 'actor-160',

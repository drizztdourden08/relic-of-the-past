 ...
 * (upstream's tables.py kSpriteNames, ~line 860). Ids continue
 ...
 * 'Mouldrum' and 0x18 'Moldorm', inverting which of the two is actually the
 * boss; see actor-137 below). Combat stats are absent on purpose (later
 * deliverable).
 */

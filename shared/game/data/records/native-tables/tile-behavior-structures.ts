...
/**
 * Behavior groups for the doors, shutters, torches and manipulable blocks in the
 * structural half of the collision switch, at core/zelda3/src/tile_detect.c:457-503.
...
import { range } from '@shared/game/data/native-tables/attr-group-map';

const STRUCTURE_BEHAVIOR_GROUPS: readonly AttrGroup<TileBehavior>[] = [
  // C:457 TileBehavior_ManipulablyReplaced is one case for the whole run. The engine
  // makes no distinction between its low and high bytes.
  { attrs: range(0x70, 0x7f), value: 'manipulably-replaced' },

  // C:463 TileHandlerIndoor_80. Its case list SKIPS 0x82 and 0x83.
  ...
  // C:481 TileBehavior_LayerAndDungeonToggleShutterDoor is one case spanning two
  ...
  // C:486 TileBehavior_DungeonToggleManualDoor again skips 0xa2/0xa3.

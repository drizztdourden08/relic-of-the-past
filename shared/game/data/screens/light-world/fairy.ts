...
const LW_FAIRY: ScreenDefinition[] = [
  ...
  { id: 'lake-hylia-healer-fairy', name: 'Great Lake Healer Fairy', type: 'interior', world: 'light', location: 'Lake Hylia', area: 'Lake Hylia', roomIndex: 0xFA, interior: { kind: 'fairy' }, tags: ['env:underground'] },

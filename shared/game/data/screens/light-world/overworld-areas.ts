...
const LW_OVERWORLD_AREAS: ScreenDefinition[] = [
  ...
  { id: 'master-sword-meadow', name: 'Master Sword Meadow', type: 'overworld', world: 'light', location: 'Lost Woods', area: 'Lost Woods', overworld: { gridX: 0, gridY: 0 }, tags: ['env:outdoor', 'loot:chest'] },
  ...
  { id: 'hyrule-castle-courtyard', name: 'Hyrule Castle Courtyard', type: 'overworld', world: 'light', location: 'Hyrule Castle', area: 'Hyrule Castle', overworld: { gridX: 0, gridY: 0 }, tags: ['env:outdoor'] },
  { id: 'hyrule-castle-ledge', name: 'Hyrule Castle Ledge', type: 'overworld', world: 'light', location: 'Hyrule Castle', area: 'Hyrule Castle', overworld: { gridX: 0, gridY: 0 }, tags: ['env:outdoor'] },
  ...
  { id: 'lake-hylia-central-island', name: 'Lake Hylia Central Island', type: 'overworld', world: 'light', location: 'Lake Hylia', area: 'Lake Hylia', overworld: { gridX: 0, gridY: 0 }, tags: ['env:outdoor'] },

...
const LW_CAVES: ScreenDefinition[] = [
  ...
  { id: 'lost-woods-hideout-top', name: 'Lost Woods Hideout (top)', type: 'interior', world: 'light', location: 'Lost Woods', area: 'Lost Woods', roomIndex: 0x00e1, interior: { kind: 'cave' }, tags: ['env:underground', 'traverse:fall'] },
  { id: 'lost-woods-hideout-bottom', name: 'Lost Woods Hideout (bottom)', type: 'interior', world: 'light', location: 'Lost Woods', area: 'Lost Woods', roomIndex: 0x00e1, interior: { kind: 'cave' }, tags: ['env:underground', 'loot:chest'] },

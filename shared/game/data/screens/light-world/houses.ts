...
const LW_HOUSES: ScreenDefinition[] = [
  ...
  { id: 'links-house', name: 'Starting House', type: 'interior', world: 'light', location: 'Central Hyrule', area: 'South Hyrule', roomIndex: 0x0104, interior: { kind: 'house' }, tags: ['env:indoor', 'role:safe', 'role:spawn'] },
  { id: 'links-house--intro', name: 'Starting House (Intro)', type: 'interior', world: 'light', location: 'Central Hyrule', area: 'South Hyrule', roomIndex: 0x0104, interior: { kind: 'house' }, variant: { key: 'intro', progressTier: 0, condition: { type: 'progress', max: 0 } }, tags: ['env:indoor', 'role:safe', 'role:spawn'] },
  ...
  { id: 'sahasrahlas-hut', name: 'First Sages Hut', type: 'interior', world: 'light', location: 'Eastern Hyrule', area: 'East Hyrule', roomIndex: 0x0107, interior: { kind: 'house' }, tags: ['env:indoor', 'loot:chest'] },

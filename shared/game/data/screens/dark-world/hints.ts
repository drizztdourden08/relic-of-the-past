...
const DW_HINTS: ScreenDefinition[] = [
  ...
  { id: 'dark-lake-hylia-ledge-hint', name: 'Dark Great Lake Ledge Hint', type: 'interior', world: 'dark', location: 'Dark Lake', area: 'Dark Lake Hylia', roomIndex: 0x011A, interior: { kind: 'hint' }, tags: ['env:underground'] },
];

...
const DW_FAIRY: ScreenDefinition[] = [
  ...
  { id: 'dark-lake-hylia-healer-fairy', name: 'Dark Great Lake Healer Fairy', type: 'interior', world: 'dark', location: 'Dark Lake', area: 'Dark Lake Hylia', roomIndex: 0xFA, interior: { kind: 'fairy' }, tags: ['env:underground'] },
  { id: 'dark-lake-hylia-ledge-healer-fairy', name: 'Dark Great Lake Ledge Healer Fairy', type: 'interior', world: 'dark', location: 'Dark Lake', area: 'Dark Lake Hylia', roomIndex: 0xFA, interior: { kind: 'fairy' }, tags: ['env:underground'] },

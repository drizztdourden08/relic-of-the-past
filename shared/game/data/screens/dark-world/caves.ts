...
const DW_CAVES: ScreenDefinition[] = [
  ...
  { id: 'dark-lake-hylia-ledge-spike-cave', name: 'Dark Great Lake Ledge Spike Cave', type: 'interior', world: 'dark', location: 'Dark Lake', area: 'Dark Lake Hylia', roomIndex: 0x0116, interior: { kind: 'cave' }, tags: ['env:underground'] },

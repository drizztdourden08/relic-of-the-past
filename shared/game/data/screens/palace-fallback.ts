...
/**
 * The palace-scan safety net for indoor screen detection.
 *
 ...
 * turns one into a developer-facing line; the renderer logs it. Tests assert that
 * the states we have ground truth for resolve exactly and never land here.
 */
 ...
 */
const scanForRoom = (byDungeonRoom: Map<string, ScreenDefinition>, room: number, actualPalace: number): { screen: ScreenDefinition; expected: number } | null => {

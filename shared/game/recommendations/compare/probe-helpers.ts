 ...
 * for is a genuine `unbacked-in-dataset` finding — the game was CHECKED and
...
/** `0x` + 2 uppercase hex digits, or an em dash for anything not finite. */
...
/** `0x` + 4 uppercase hex digits, or an em dash for anything not finite. */
 ...
 * An em dash for nothing, the primitive as-is for a primitive, and JSON for

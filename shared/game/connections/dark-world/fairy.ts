...
export const DW_FAIRY_CONNECTIONS: RegionConnection[] = [
  { from: 'east-dark-world', to: 'pyramid-fairy', entrance: 'Pyramid Fairy', tags: ['transit:bomb', 'dir:two-way', 'ctx:entrance', 'barrier:bomb'] },
  { from: 'south-dark-world', to: 'bonk-fairy-dark', entrance: 'Bonk Fairy (Dark)', tags: ['transit:bonk', 'dir:two-way', 'ctx:entrance', 'barrier:dash'] },
  { from: 'east-dark-world', to: 'dark-lake-hylia-healer-fairy', entrance: 'Dark Lake Hylia Fairy', tags: ['transit:door', 'dir:two-way', 'ctx:entrance'] },

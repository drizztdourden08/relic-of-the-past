...
export const LW_TOWER_OF_HERA_CONNECTIONS: RegionConnection[] = [
  { from: 'lw-03', to: 'toh-0x77', entrance: 'Tower Entrance', tags: ['transit:door', 'dir:two-way', 'ctx:dungeon-enter'] },
  ...
  { from: 'toh-0x17', to: 'toh-0x07', entrance: '6F Boss Stairs', tags: ['transit:stairs', 'dir:two-way', 'ctx:boss', 'barrier:big-key'] },
  ...
  { from: 'toh-0x87', to: 'toh-0x77', entrance: 'Cage Return Stairs', tags: ['transit:stairs', 'dir:one-way', 'ctx:internal'] },

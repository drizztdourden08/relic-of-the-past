 ...
 * setting, derived instead of asked for twice.
 *
 ...
 * instead of a step back down; the core's own ladder reading answers that,
 * because it resolves against live inventory instead of against a count.
 */
